    ...
    <>
      <Wrapper>
        ...
        <WrappForm>
          ...
          <ConfirmCode href={"/game?roomNumber=" + roomNumber}>
            Join Room
          </ConfirmCode>
        </WrappForm>
        <CreateRoom href="/game?isPrivate=true">Create Room</CreateRoom>
        <PlayBot href="/game?isPrivate=true&botEnemy=true">
